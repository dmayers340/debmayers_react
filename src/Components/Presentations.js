                    ...
                    <Card style={{ width: '20rem', height: '20rem', marginBottom: '1rem' }}>
                        ...
                        <Card.Body>
                            <object data="doc/GettingStartedWithSpatialComputing.pdf" type="application/pdf" width="100%" height="100%">
                                <p>Or download <a href="doc/GettingStartedWithSpatialComputing.pdf">the PDF!</a></p>
                            </object>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card style={{ width: '20rem', height: '20rem', marginBottom: '1rem' }}>
                        ...
                        <Card.Body>
                            <object data="doc/Mayers_RememberingMithras_TRAC_Final.pdf" type="application/pdf" width="100%" height="100%">
                                <p>Or download <a href="doc/Mayers_RememberingMithras_TRAC_Final.pdf">the PDF!</a></p>
                            </object>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card style={{ width: '20rem', height: '20rem', marginBottom: '1rem' }}>
                        ...
                        <Card.Body>
                            <object data="doc/Mayers_AR_VR_Enterprises.pdf" type="application/pdf" width="100%" height="100%">
                                <p>Or download <a href="doc/Mayers_AR_VR_Enterprises.pdf">the PDF!</a></p>
                            </object>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card style={{ width: '20rem', height: '20rem', marginBottom: '1rem' }}>
                        ...
                        <Card.Body>
                            <object data="doc/Mayers_LearningAndVR.pdf" type="application/pdf" width="100%" height="100%">
                                <p>Or download <a href="doc/Mayers_LearningAndVR.pdf">the PDF!</a></p>
                            </object>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card style={{ width: '20rem', height: '20rem', marginBottom: '1rem' }}>
                        ...
                        <Card.Body>
                            <object data="doc/Mayers_RecreatingThePastUsingSensoryFeedback.pdf" type="application/pdf" width="100%" height="100%">
                                <p>Or download <a href="doc/Mayers_RecreatingThePastUsingSensoryFeedback.pdf">the PDF!</a></p>
                            </object>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card style={{ width: '20rem', height: '20rem', marginBottom: '1rem' }}>
                        ...
                        <Card.Body>
                            <object data="doc/Mayers_You_And_Your_Avatar.pdf" type="application/pdf" width="100%" height="100%">
                                <p>Or download <a href="doc/Mayers_You_And_Your_Avatar.pdf">the PDF!</a></p>
                            </object>
                        </Card.Body>
                    </Card>
                </Col>
