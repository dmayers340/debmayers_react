...
import PointerLockControls from '../extra/PointerLockControls';
import DDSLoader from '../extra/DDSLoader';
...
export const Experience = (props) => {
    ...
    if(props.match.params.name === 'Carrawburgh') {
        return carrawburgh = () => {
            let container;
    ...
    const currentExperience = experiences.includes(props);
    
    return(
    <div>
        <h1>{props.match.params.name}</h1>
        {props.match.params.name === 'Carrawburgh' ? carrawburgh : 'Clicked'}
    </div>
    )
